-- ============================================================
-- 026_feed_rpc_quote_repost_fields.sql
-- Adds quote_of and repost_of to get_hybrid_campus_feed so the
-- client can call enrichWithOriginalPosts and render QuotePostCard.
-- ============================================================

-- Must drop first because the return type is changing.
DROP FUNCTION IF EXISTS get_hybrid_campus_feed(uuid, integer, integer);
